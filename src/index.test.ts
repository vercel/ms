...
describe('ms(number, { long: true })', () => {
  ...
  it('should support weeks', () => {
    ...
    expect(ms(6 * 7 * 24 * 60 * 60 * 1000, { long: true })).toBe('6 weeks');

    expect(ms(-1 * 1 * 7 * 24 * 60 * 60 * 1000, { long: true })).toBe(
      '-1 week',
    );
    expect(ms(-1 * 6 * 7 * 24 * 60 * 60 * 1000, { long: true })).toBe(
      '-6 weeks',
    );
  });
...
describe('ms(number)', () => {
  ...
  it('should support weeks', () => {
    ...
    expect(ms(6 * 7 * 24 * 60 * 60 * 1000)).toBe('6w');

    expect(ms(-1 * 1 * 7 * 24 * 60 * 60 * 1000)).toBe('-1w');
    expect(ms(-1 * 6 * 7 * 24 * 60 * 60 * 1000)).toBe('-6w');
  });
