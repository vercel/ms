...
describe("ms.parse()", () => {
	it("should throw an error for strings longer than 100 characters", () => {
	...
	it("should return NaN for invalid unit types", () => {
		expect(Number.isNaN(parse("10unknown"))).toBe(true);
	});
